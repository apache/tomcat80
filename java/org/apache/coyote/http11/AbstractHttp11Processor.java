...
import static org.apache.coyote.http11.compression.CompressionLevel.*;
...
public abstract class AbstractHttp11Processor<S> extends AbstractProcessor<S> {
     ...
     */
    protected CompressionLevel compressionLevel = OFF;
    ...
    public void setCompression(String compression) {
        ...
        if (compressionLevel == null) {
            try {
                ...
                this.compressionLevel = ON;
            } catch (NumberFormatException e) {
                this.compressionLevel = OFF;
            }
        }
    }
    ...
    private boolean isCompressable() {
        ...
        if ((contentEncodingMB != null)
            && (contentEncodingMB.indexOf(GZIP_CONTENT_ENCODING) != -1)) {
            return false;
        }
